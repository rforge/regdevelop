...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in check.ploption(lnam, lopt): :check.ploption: argument 'condquant' not suitable. It should\\\#\#\ \  be of mode logical (or interpretable as such)}}
...
\;.
\]
  Contour lines are drawn for $D_i\sups C=\pm c^2$, where $c$ is given 
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in par(loldpar): "{}mfig"{} is not a graphical parameter}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in par(loldpar): "{}mrow"{} is not a graphical parameter}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in par(loldpar): "{}mcol"{} is not a graphical parameter}}\end{kframe}
