...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plmframes}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{2}\hlstd{)}
...
(\T{plyx, plmatrix, plmboxes, plregr}), as well as \T{plframe},
...
\hlkwd{attr}\hlstd{(iris}\hlopt{$}\hlstd{Sepal.Length,} \hlstr{"ticksat"}\hlstd{)} \hlkwb{<-}
  \hlkwd{structure}\hlstd{(}\hlkwd{seq}\hlstd{(}\hlnum{4}\hlstd{,} \hlnum{8}\hlstd{,} \hlnum{1}\hlstd{),} \hlkwc{small}\hlstd{=}\hlkwd{seq}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{8}\hlstd{,}\hlnum{0.1}\hlstd{))}
...
##  - attr(*, "ticksat")= num [1:3] 0 0.5 1
##  - attr(*, "ticklabels")= chr [1:3] "0" "50" "100"
