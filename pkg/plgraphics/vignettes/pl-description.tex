...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(axis, at = lat, labels = llab, col = col, ...): 'labels' is supplied and not 'at'}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in max(abs(as.numeric(lattrj\$innerrange))): no non-missing arguments to max; returning -Inf}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(axis, at = lat, labels = llab, col = col, ...): 'labels' is supplied and not 'at'}}
