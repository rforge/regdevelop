...
\Detail{The function \T{fitcomp} calculates the coordinates of the 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plresx}\hlstd{(r.blast,} \hlkwc{transformed}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{reflineband}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{xvar}\hlstd{=}\hlopt{~}\hlstd{.}\hlopt{-}\hlstd{location)}
\end{alltt}
\end{kframe}
...
\begin{alltt}
  ...
  \hlkwd{plmframes}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{,} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{))}
  \hlkwd{plregr}\hlstd{(r.babys,} \hlkwc{plotselect}\hlstd{=}\hlkwd{c}\hlstd{(}\hlkwc{resfit}\hlstd{=}\hlnum{2}\hlstd{,} \hlkwc{default}\hlstd{=}\hlnum{0}\hlstd{),} \hlkwc{xvar}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
