...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in apply(lstdres, 2, function(x) plmark(lmxres, x, plabel = plargs\$plabel)): dim(X) must have a positive length}}\end{kframe}
\end{knitrout}
