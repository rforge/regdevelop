...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plmfg}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{,} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{))}
...
\hlkwd{plmfg}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{,} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{))}
...
\begin{alltt}
  ...
  \hlstd{t.i} \hlkwb{<-} \hlstd{d.river}\hlopt{$}\hlstd{date} \hlopt{<} \hlkwd{as.Date}\hlstd{(}\hlstr{"2010-03-31"}\hlstd{)}
  \hlstd{t.d} \hlkwb{<-} \hlstd{d.river[t.i} \hlopt{&} \hlstd{d.river}\hlopt{$}\hlstd{hour}\hlopt{==}\hlnum{14}\hlstd{,]}
  \hlkwd{plyx}\hlstd{(T}\hlopt{+}\hlstd{O2}\hlopt{+}\hlstd{ra}\hlopt{+}\hlstd{Q}\hlopt{~}\hlstd{date,} \hlkwc{data}\hlstd{=t.d,} \hlkwc{smooth.par}\hlstd{=}\hlnum{0.5}\hlstd{,} \hlkwc{smooth.xtrim}\hlstd{=}\hlnum{0.03}\hlstd{,}
       \hlkwc{smoothline.lty}\hlstd{=}\hlnum{1}\hlstd{,} \hlkwc{sub}\hlstd{=}\hlstr{"river data"}\hlstd{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plmfg}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{,} \hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{))}
...
The figure shows the versions of these displays obtained by \T{plot.regr}.
...
The leverage plot of \T{plot.regr} uses \emph{standardized} residuals
...
\begin{alltt}
\hlkwd{data}\hlstd{(d.blast)}
\hlstd{dd} \hlkwb{<-} \hlstd{d.blast[}\hlkwd{as.numeric}\hlstd{(d.blast}\hlopt{$}\hlstd{location)}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{),]}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in condquant(llim, ldist, lsig): :condquant: probabilities <0 or >1}}\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{t.plopt} \hlkwb{<-} \hlkwd{ploptions}\hlstd{(}\hlkwc{col}\hlstd{=}\hlstr{"magenta"}\hlstd{,} \hlkwc{pch}\hlstd{=}\hlnum{3}\hlstd{,} \hlkwc{smoothlines.lty}\hlstd{=}\hlnum{3}\hlstd{)}
\hlkwd{plyx}\hlstd{(Sepal.Width}\hlopt{~}\hlstd{Sepal.Length,} \hlkwc{data}\hlstd{=iris)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{attr}\hlstd{(iris}\hlopt{$}\hlstd{Sepal.Length,} \hlstr{"ticksat"}\hlstd{)} \hlkwb{<-}
  \hlkwd{structure}\hlstd{(}\hlkwd{seq}\hlstd{(}\hlnum{4}\hlstd{,} \hlnum{8}\hlstd{,} \hlnum{0.5}\hlstd{),} \hlkwc{small}\hlstd{=}\hlkwd{seq}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{8}\hlstd{,}\hlnum{0.1}\hlstd{))}
...
\Tit{\T{gentimeaxis}.}
The function \T{gentimeaxis} provides nice tick values and labels for 
...
\item
  ...
  It is used by \T{plot.regr} and \T{plresx}.
...
\T{fitted.regrpolr, residuals.polr, residuals.regrsurvreg, 
  residuals.regrcoxph}.
...
The pl functions \T{plot.regr, plresx, plres2x} work with the extended
