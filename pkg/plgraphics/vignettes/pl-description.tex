...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in loess.control(...): as.integer(iterations) > 0L is not TRUE}}\end{kframe}
...
##  - attr(*, "ticksat")= num [1:4] 0 0.295 0.5 0.705
...
\T{gensmooth}, that in turn calls the function determined by
