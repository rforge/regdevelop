...
for the different groups specified by the levels of \T{by}, 
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in lf.tickat(ldtk\$smallunit[lidtk], ldtk\$smallint[lidtk], llev = llev, : debug lf.ticksat: length(ltat)!=length(ltatu)}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in lf.tickat(ldtk\$bigunit[lidtk], ldtk\$bigint[lidtk], llev = llev, : debug lf.ticksat: length(ltat)!=length(ltatu)}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in lf.tickat(llunit, llint, llev = llev, llvlg = llvlg, ystart = lystart, : debug lf.ticksat: length(ltat)!=length(ltatu)}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in data(lung, package = "{}survival"{}): data set 'lung' not found}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in data(lung): data set 'lung' not found}}\begin{alltt}
...
\item
  \T{plcoord}: plotting coordinates, if different from the variable's data
